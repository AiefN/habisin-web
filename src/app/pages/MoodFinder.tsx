...
export function MoodFinder() {
  ...
  return (
    <div style={{ backgroundColor: "#F5F5F5", minHeight: "100vh", fontFamily: "'Inter', sans-serif" }}>
      {/* Header */}
      <div
        style={{ background: "linear-gradient(135deg, #023820 0%, #034D2C 60%, #0D6B47 100%)" }}
      ...
      >
        ...
        <div className="relative z-10 max-w-[800px] mx-auto">
          <div
            ...
            style={{ backgroundColor: "rgba(238, 63, 36, 0.2)", border: "1px solid rgba(238, 63, 36, 0.35)" }}
          >
            <span style={{ fontSize: "14px" }}>✨</span>
            <span style={{ color: "#FFEFCB", fontSize: "13px", fontWeight: 600 }}>Mood Finder</span>
          </div>
          <h1
            style={{
          ...
          >
            Hari Ini Kamu<br />
            <span style={{ color: "#F9A11B" }}>Ingin Makan Apa?</span>
          </h1>
          <p style={{ color: "#E8F5E9", fontSize: "16px", lineHeight: 1.7 }}>
      ...
      <div className="max-w-[1440px] mx-auto px-8 py-14">
        {/* ─── MOOD CARDS ─── */}
        <div className="mb-10">
          <h2 style={{ fontFamily: "'Playfair Display', serif", color: "#023820", fontSize: "28px", fontWeight: 600, textAlign: "center", marginBottom: "8px" }}>
            Pilih Mood Makanmu
          </h2>
          <p style={{ color: "#666666", textAlign: "center", fontSize: "14px", marginBottom: "30px" }}>
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <button
              ...
              className="col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-2 p-6 rounded-2xl text-left transition-all duration-300"
              style={{
                background: "linear-gradient(135deg, #023820, #0D6B47)",
                border: "2px solid #FFEFCB",
                boxShadow: "0 2px 10px rgba(0, 0, 0, 0.08)",
              }}
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLElement).style.transform = "scale(1.03) translateY(-2px)";
                (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 25px rgba(255, 239, 203, 0.3)";
              }}
              onMouseLeave={(e) => {
            ...
            >
              ...
              <p style={{ fontFamily: "'Playfair Display', serif", color: "#FFEFCB", fontSize: "18px", fontWeight: 600, marginBottom: "6px" }}>
                Acak!
              </p>
              <p style={{ color: "#E8F5E9", fontSize: "12px", lineHeight: 1.5 }}>
        ...
        <div className="flex justify-center mb-14">
          <button
            ...
            style={{
              background: "linear-gradient(135deg, #EE3F24, #F9A11B)",
              boxShadow: "0 4px 20px rgba(238, 63, 36, 0.4)",
            }}
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.transform = "translateY(-2px)";
              (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 30px rgba(238, 63, 36, 0.5)";
            }}
            onMouseLeave={(e) => {
          ...
          <div className="text-center py-16">
            <div className="inline-flex flex-col items-center gap-4">
              <div
                ...
                style={{ borderColor: "#FFEFCB", borderTopColor: "#EE3F24" }}
              />
              <p style={{ color: "#666666", fontSize: "16px" }}>Mencari rekomendasi terbaik...</p>
            </div>
          </div>
        )}
        ...
        {!isAnimating && recommendations.length > 0 && (
          <div>
            ...
            <div
              ...
              style={{ background: "linear-gradient(135deg, #023820, #0D6B47)", border: "1px solid rgba(255, 239, 203, 0.2)" }}
            >
              <span style={{ fontSize: "28px" }}>
                {selectedMood ? moods.find((m) => m.id === selectedMood)?.emoji : "🎲"}
              </span>
              <div>
                <h2 style={{ fontFamily: "'Playfair Display', serif", color: "#FFEFCB", fontSize: "22px", fontWeight: 600 }}>
                  {selectedMood
                    ? `Rekomendasi untuk Mood "${selectedMood}"`
                    : "Rekomendasi Acak Untuk Kamu"}
                </h2>
                <p style={{ color: "#E8F5E9", fontSize: "13px" }}>
